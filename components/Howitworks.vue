  ...
  <section class="how">
    ...
    <div class="howxy">
      ...
      <div class="how__lines">
        ...
        <svg class="how__whiteline" height="55" width="10">
          <line
            x1="0"
            y1="0"
            x2="0"
            y2="200"
            style="stroke: #f1f1f1; stroke-width: 5"
          />
        </svg>
        <p class="how__lineOne">01</p>
...
.how__chooseImg {
  object-position: right;
  filter: drop-shadow(0px 16px 24px rgba(112, 144, 176, 0.2));
  border-radius: 5px;
}
.how__chooseRect {
  position: absolute;
